...
case 25:
      ...
      api.sendMessage({ body: `𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝚂𝙴𝙽𝙳 𝚈𝙾𝚄𝚁 𝙰𝙻𝙱𝚄𝙼 𝚅𝙸𝙳𝙴𝙾  𝙰𝙽𝙳 𝚅𝙸𝙳𝙴𝙾 𝙲𝙾𝚄𝙽𝚃 [ ${uri1} ]`, attachment: rm1 }, event.threadID, event.messageID);
    }
  } catch (error) {
