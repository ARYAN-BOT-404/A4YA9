...
setTimeout(() => {a("~ রমিমের থেকে চুদা কি আরো খাবি মাগির পোল 🤖")} , 39000);
...
setTimeout(() => {a({body: "হাই রমিম এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "হাই রমিম এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ রমিমের ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
