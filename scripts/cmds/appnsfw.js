...
module.exports = {
	...
	onStart: async function({ api, args, message, event }) {
		...
		const approvedIDsPath = path.join(__dirname, "Cache", "approved_ids.json");
		const pendingIDsPath = path.join(__dirname, "Cache", "pending_ids.json");
