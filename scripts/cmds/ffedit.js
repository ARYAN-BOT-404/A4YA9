module.exports = {
  ...
  const fs = require("fs");
  var romim = ["https://a6-video-api.onrender.com/video/editff","https://a6-video-api.onrender.com/video/sadff"]
  ...
  let callback = function () {
          api.sendMessage({
            body: `𝚂𝚄𝙲𝙲𝙴𝚂𝚂𝙵𝚄𝙻𝙻𝚈 𝙰𝙿𝙸 𝚂𝙴𝙽𝙳 𝚅𝙸𝙳𝙴𝙾                           𝙵𝚁𝙴𝙴 𝙵𝙸𝚁𝙴 𝙴𝙳𝙸𝚃  𝚅𝙸𝙳𝙴𝙾\n\n｢ 𝚁𝙾𝙼𝙸𝙼 𝙰𝙷𝙼𝙴𝙳  ｣`,
